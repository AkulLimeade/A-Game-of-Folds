...
coverflowimages({
	coverid: 'coverflow1',
	images: [
						['devildragon.png', 'devildragon.png', ],
						['devildragon2.png', 'devildragon2.png', ],
						['devildragon3.png', 'devildragon3.png'],
						['devildragon4.png', 'devildragon4.png', ],
						['devildragon5.png', 'devildragon5.png', ] // <-- no comma after last image
